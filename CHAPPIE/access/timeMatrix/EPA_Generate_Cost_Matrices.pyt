...
class Toolbox(object):
    def __init__(self):
        ...
        self.alias = "GenerateCostMatrix"
        # List of tool classes associated with this toolbox
        self.tools= [EPA_Cost_Matrix]
class EPA_Cost_Matrix(object):
    def __init__(self):
        self.label = "Cost Matrix" 
        self.description = "This tool generates a travel network cost matrix given two sets of points"

    def getParameterInfo(self):
        origins = arcpy.Parameter()
        origins.displayName = 'Origins'
        origins.name = 'Origins'
        origins.datatype = 'GPLayer'
        origins.parameterType = 'Required'
        origins.direction = 'Input'
        
        destinations = arcpy.Parameter()
        destinations.displayName = 'Destinations'
        destinations.name = 'Destinations'
        destinations.datatype = 'GPLayer'
        destinations.parameterType = 'Required'
        destinations.direction = 'Input'

        startRun = arcpy.Parameter()
        startRun.displayName = 'Starting pair'
        startRun.name = 'startRun'
        startRun.datatype = 'GPLong'
        startRun.parameterType = 'Optional'
        startRun.direction = 'Input'
        
        out_csv = arcpy.Parameter()
        out_csv.displayName = 'Results csv'
        out_csv.name = 'out_csv'
        out_csv.datatype = 'DEFile'
        out_csv.parameterType = 'Optional'
        out_csv.direction = 'Output'

        params = [origins, destinations, startRun, out_csv]
