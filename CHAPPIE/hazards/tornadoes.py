...
def get_tornadoes_all(out_dir, component='torn-aspath', years='1950-2022'):
    ...
    """
    valid_components = ['torn-aspath', 'torn-initpoint', 'torn.csv']
    assert component in valid_components, f'"{component}" invalid'
...
def process_tornadoes(tornadoes_gdf, aoi):
    ...
    # buffer lines in filtered tornadoes
    # Note: (sf::st_buffer defaults join_style and cap_style are same)
